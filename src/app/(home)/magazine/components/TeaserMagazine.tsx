...
export default function TeaserMagazine() {
  return (
      ...
      ">
        <motion.div
          ...
          <motion.span
            ...
            max-lg:py-1.5
          ">
            <Play className="max-lg:w-4 max-lg:h-4" /> Assista ao Teaser da
            Revista
          </motion.span>
          ...
          ">
            A revista LOCAL CONTENT MAGAZINE foi criada para destacar o que é nosso.
          </motion.h1>
