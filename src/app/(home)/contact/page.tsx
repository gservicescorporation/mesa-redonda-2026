...
export default function Contact() {
  return (
    <div className="w-full bg-[url(https://ik.imagekit.io/globalsc/mr-nov-2024/53.jpeg)]">
      <div className="flex items-center gap-24 px-24 py-32 max-lg:px-0 max-lg:py-16 max-lg:gap-12 justify-center w-full bg-linear-to-b from-accent/70 to-accent/85 backdrop-blur-xs">
        <div className="max-w-7xl w-full flex items-center justify-around gap-16 max-lg:flex-col max-lg:gap-12">
          <ul className="flex flex-col gap-12 w-full max-w-xl max-lg:px-8 max-lg:py-12">
            <li className="flex gap-8 max-lg:gap-4">
          ...
          <div className="max-w-xl w-full backdrop-blur-2xl flex flex-col gap-5 lg:rounded-3xl px-12 py-12 max-lg:px-6 max-lg:py-8 bg-linear-to-b from-primary/10 to-accent/5">
